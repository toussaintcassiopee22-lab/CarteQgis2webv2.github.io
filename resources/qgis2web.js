...
map.getView().fit([676439.003306, 6209092.118037, 709253.828297, 6230266.596424], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte interactive regroupant l’ensemble des projets et travaux de renaturation réalisés  </h2>';
        return titleElement;
    })(),
